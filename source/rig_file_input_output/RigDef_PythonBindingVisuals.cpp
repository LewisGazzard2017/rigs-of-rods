...
void PythonBinding::ExportVisuals()
{
    ...
    class_<RigDef::ManagedMaterial>("ManagedMaterial")
        ...
        .def_readwrite("use_option_doublesided", &ManagedMaterial::options::double_sided)
    ...
    class_<RigDef::Flexbody>("Flexbody")   
        ...
        .def_readwrite("Ogre::Vector3 offset",   &Flexbody::Ogre::Vector3 offset)
        .def_readwrite("Ogre::Vector3 rotation", &Flexbody::Ogre::Vector3 rotation)
    ...
    enum_<RigDef::MapMode>("MapMode")
        .value("OFF",       MapMode::MAP_MODE_OFF)
        .value("SIMPLE",    MapMode::MAP_MODE_SIMPLE)
        .value("ZOOM",      MapMode::MAP_MODE_ZOOM)
        .value("INVALID",   MapMode::MAP_MODE_INVALID)
        ; 

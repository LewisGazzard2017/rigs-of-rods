...
void PythonBinding::ExportPropsAndAnimations()
{
    ...
    class_<RigDef::Prop>("Prop")   
        ...
        .def_readwrite("Ogre::Vector3 offset",        &Prop::Ogre::Vector3 offset)
        .def_readwrite("Ogre::Vector3 rotation",      &Prop::Ogre::Vector3 rotation)
    ...
    enum_<RigDef::RigDef::MotorSource::WhichSource>("AnimationSourceMotorDetail")
        .value("AERO_INVALID",  MotorSource::SOURCE_AERO_INVALID)
        .value("AERO_THROTTLE", MotorSource::SOURCE_AERO_THROTTLE)
        .value("AERO_RPM",      MotorSource::SOURCE_AERO_RPM     )
        .value("AERO_TORQUE",   MotorSource::SOURCE_AERO_TORQUE  )
        .value("AERO_PITCH",    MotorSource::SOURCE_AERO_PITCH   )
        .value("AERO_STATUS",   MotorSource::SOURCE_AERO_STATUS  )
        ;

    PYTHON_REGISTER_STD_VECTOR(RigDef::MotorSource, "MotorSourceVector")
    class_<RigDef::MotorSource>("AnimationMotorSource")
        .def_readwrite("source", &MotorSource::source)
        .def_readwrite("motor",  &MotorSource::motor)
        ;

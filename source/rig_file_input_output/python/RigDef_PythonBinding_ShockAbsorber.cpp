...
void PythonBinding::ExportShockAbsorber()
{
    ...
    class_<RigDef::Shock2>("ShockAbsorber2")   
        ...
        .add_property("option_i_invisible",        &Shock2::HasOption_i_Invisible,         &Shock2::SetOption_i_Invisible) 
        .add_property("option_s_soft_bump_bounds", &Shock2::HasOption_s_SoftBumpBounds,    &Shock2::SetOption_s_SoftBumpBounds)
        .add_property("option_m_metric",           &Shock2::HasOption_m_Metric,            &Shock2::SetOption_m_Metric)
        .add_property("option_m_absolute_metric",  &Shock2::HasOption_M_AbsoluteMetric,    &Shock2::SetOption_M_AbsoluteMetric)
        
        .def_readwrite("spring_in",                  &Shock2::spring_in)
        .def_readwrite("damp_in",                    &Shock2::damp_in)
        .def_readwrite("progress_factor_spring_in",  &Shock2::progress_factor_spring_in)
        .def_readwrite("progress_factor_damp_in",    &Shock2::progress_factor_damp_in)
        .def_readwrite("spring_out",                 &Shock2::spring_out)
        .def_readwrite("damp_out",                   &Shock2::damp_out)
        .def_readwrite("progress_factor_spring_out", &Shock2::progress_factor_spring_out)
        .def_readwrite("progress_factor_damp_out",   &Shock2::progress_factor_damp_out)
        .def_readwrite("short_bound",                &Shock2::short_bound)
        .def_readwrite("long_bound",                 &Shock2::long_bound)
        .def_readwrite("precompression",             &Shock2::precompression)
        .def_readwrite("beam_defaults",              &Shock2::beam_defaults)
        .def_readwrite("detacher_group",             &Shock2::detacher_group)
        ;

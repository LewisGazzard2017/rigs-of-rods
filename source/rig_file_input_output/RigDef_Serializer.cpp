...
void Serializer::Serialize()
{
	...
	m_stream
		<< "; ---------------------------------------------------------------------------- ;" << endl
		<< "; Rigs of Rods project (http://www.rigsofrods.com)                             ;" << endl
		<< "; ================================================                             ;" << endl
		<< ";                                                                              ;" << endl
    ...
    // File format version
    m_stream << "fileformatversion 450" << endl << endl;
...
void Serializer::ProcessNodes(File::Module* module)
{
	...
	for (auto itor = module->nodes.begin(); itor != itor_end; ++itor)
	{
		...
		// Check zero node
		if (node.id.IsValid() && node.id.Str() == "0")
		{

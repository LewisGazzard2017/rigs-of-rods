...
public:
    ...
    */
     ...
     * @param arg A declaration for the function.
    */
    AngelScript::asIScriptFunction* functionExists(const Ogre::String& arg);

    /**
     * Deletes a global function from the script
     * @param arg A declaration for the function.
    */
    AngelScript::asIScriptFunction* deleteFunction(const Ogre::String& arg);
    ...
    */
    ...
    //NEXTSIM-FIXME//Ogre::StringVector getAutoComplete(Ogre::String command);

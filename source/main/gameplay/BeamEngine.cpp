...
void BeamEngine::LogFullState()
{
    ...
    sprintf(msg,"DBG Powertrain "
        ...
        "| conf_num_turbos %12.2f "
        "| conf_turbo_max_rpm %12.2f "
        "| conf_turbo_engine_rpm_operation %12.2f "
        "| conf_turbo_version %12.2f "
        "| conf_turbo_min_bov_psi %12.2f "
        ...
        m_conf_num_turbos,
        m_conf_turbo_max_rpm,
        m_conf_turbo_engine_rpm_operation,
        m_conf_turbo_version,
        m_conf_turbo_min_bov_psi,

...
bool ODefParser::ProcessCurrentLine()
{
    ...
    else if (StartsWith(line_str, "spotlight"))
    {
        ...
        int res = sscanf(line_str.c_str(), "spotlight %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f, %f",
            &l.pos.x, &l.pos.y, &l.pos.z, &l.dir.x, &l.dir.y, &l.dir.z,
            &l.color.r, &l.color.g, &l.color.b, &l.range, &l.angle_inner, &l.angle_outer);
        if (res == 12)
        {
            snprintf(l.name, ODef::STR_LEN, "spotlight_%04x", s_unique_id_source++);
            m_def->spotlights.push_back(l);
        }
        else
        {
    ...
    else if (StartsWith(line_str, "pointlight"))
    {
        ...
        int res = sscanf(line_str.c_str(), "pointlight %f, %f, %f, %f, %f, %f, %f, %f, %f, %f",
            &l.pos.x, &l.pos.y, &l.pos.z, &l.dir.x, &l.dir.y, &l.dir.z,
            &l.color.r, &l.color.g, &l.color.b, &l.range);
        if (res == 10)
        {
            snprintf(l.name, ODef::STR_LEN, "pointlight_%04x", s_unique_id_source++);
            m_def->point_lights.push_back(l);
        }
        else
        {

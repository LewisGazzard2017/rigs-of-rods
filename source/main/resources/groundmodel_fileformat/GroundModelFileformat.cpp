        ...
        for (auto& entry: section_entries)
        {
            ...
            else if (entry.first == "fx_type")
            {
                ...
                else
                {
                    ...
                    msg << "Invalid 'fx_type' value '" << entry.second <<"' in groundmodel '" << section_name << "' (file: " << m_filename << ")";
            ...
            {
                std::stringstream msg;
                msg << "Invalid keyword '" << entry.first <<"' in groundmodel '" << section_name << "' (file: " << m_filename << ")";
                m_messages.push_back(msg.str());
            }
        }
    }

...
void MyGUI_PythonExport::ExportClassWidget()
{
	...
	class_<MyGUI::Widget, boost::noncopyable>("MyGUI_Widget", no_init)
		...
		// Typecasts
		.def("cast_type_Button",     &PY_Widget_CastType_Button,     return_value_policy<reference_existing_object>())
		.def("cast_type_EditBox",    &PY_Widget_CastType_EditBox,    return_value_policy<reference_existing_object>())
		.def("cast_type_ComboBox",   &PY_Widget_CastType_ComboBox,   return_value_policy<reference_existing_object>())
		.def("cast_type_TextBox",    &PY_Widget_CastType_TextBox,    return_value_policy<reference_existing_object>())
		.def("cast_type_MenuBar",    &PY_Widget_CastType_MenuBar,    return_value_policy<reference_existing_object>())
		.def("cast_type_PopupMenu",  &PY_Widget_CastType_PopupMenu,  return_value_policy<reference_existing_object>())
		.def("cast_type_Window",     &PY_Widget_CastType_Window,     return_value_policy<reference_existing_object>())
		// Methods
